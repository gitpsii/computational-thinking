...
begin
	ex_1_1 = md"""
	If you guess a too small then x/a would be too large and conversley if you guess a too large then x/a is too small giving you a range that makes up the square root to be mathematically in between a and x/a.
	"""
end
...
manifest_format = "2.0"
project_hash = "0564ce862820a3c7ed79d3e97314ee680a685095"
